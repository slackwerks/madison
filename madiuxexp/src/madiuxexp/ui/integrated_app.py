"""
Integrated Textual application that connects to Madison core components.

This extends the split-screen UI with real Madison functionality.
"""
...
from .textual_app import MadisonTUIApp
from .textual_ui import SplitScreenContainer

logger = logging.getLogger(__name__)


class IntegratedMadisonApp(MadisonTUIApp):
    """Madison TUI application with real backend integration."""

    def __init__(self, config: Optional[Config] = None, model: Optional[str] = None):
        """Initialize the integrated Madison app.
